 ...
 *
 * File name: main.c
 * Project name: RTC_Date_TIme
 *
 * Description: Using RTC block and print date/time data when button pressed
 * 				Case 1: Time format 12h
 * 				Case 2: Time format 24h
 * 				Case 3: Do system reset and observe the effect on your config to RTC
 * 				Case 4: See effect of RTC when system exit Standby mode
 * Chap 27 vid 6 to 10
 *
 */
